...
print(re.findall(r'ama[do]*', texto2, flags=re.I)) #1 forma
print(re.findall(r'ama[do]{0,2}', texto2, flags=re.I)) #2 forma
print(re.findall(r'ama[od]{0,2}', texto2, flags=re.I)) #3 forma